...
/**
 * Enhanced UART Peripheral with FIFOs and Flow Control
 * 
...
module uart_peripheral_enhanced (
    ...
    // This will be controlled by register interface
    assign rx_ready_to_reg = !rx_fifo_empty;
    
    // Note: rx_fifo_rd_en will be generated by register interface when CPU reads RX_DATA
    // For now, auto-read (data always available)
    assign rx_fifo_rd_en = 1'b0;  // Will be updated when integrating with reg interface
