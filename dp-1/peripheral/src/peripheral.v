...
/**
 * TinyQV UART Peripheral
 * 
 * Memory-mapped UART peripheral for TinyQV RISC-V core.
 * Supports 4 baud rates: 9600, 19200, 38400, 115200
 * 
 * Register Map:
 * 0x00 - CTRL:    [3:0] baud_sel, [4] tx_enable, [5] rx_enable
 * 0x04 - STATUS:  [0] tx_busy, [1] rx_ready, [2] rx_error
...
module tqvp_basit_uart (
    ...
    // Instantiate complete UART peripheral
